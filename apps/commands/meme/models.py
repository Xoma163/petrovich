...
class BaseMeme(TimeStampModelMixin):
    ...
    file = models.FileField("Файл", upload_to="commands/memes/memes", null=True)
    file_preview = models.FileField("Файл превью", upload_to="commands/memes/memes_preview", null=True)
