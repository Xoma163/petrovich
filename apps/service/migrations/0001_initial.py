    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_thread_id',
                 models.IntegerField(blank=True, default=None, null=True, verbose_name='message_thread_id')),
                ('channel_id', models.CharField(blank=True, max_length=100, null=True, verbose_name='ID канала')),
                ...
                ('last_videos_id',
                 models.JSONField(blank=True, max_length=100, null=True, verbose_name='ID последних видео')),
                ('service',
                 models.SmallIntegerField(blank=True, choices=[(1, 'YouTube'), (4, 'VK'), (5, 'Premiere')], default=1,
                                          verbose_name='Сервис')),
                ('save_to_plex', models.BooleanField(default=False, verbose_name='Сохранять в plex')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_personal', models.BooleanField(default=False, verbose_name='Персональный')),
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bot.profile',
                                             verbose_name='Пользователь')),
            ],
            options={
