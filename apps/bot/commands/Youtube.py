...
class YouTube(CommonCommand):
    ...
    help_texts = [
        ...
        "Чтобы узнать id канала нужно перейти на канал и скопировать содержимое после https://www.youtube.com/channel/**********\n"
        "Чтобы узнать название канала, нужно перейти на канал и скопировать содержимое после https://www.youtube.com/user/********** или https://www.youtube.com/**********\n"
