...
class TimeTable(CommonCommand):
    name = "расписание"
    names = ["расп"]
    help_text = "присылает расписание в конфах с расписанием"
    help_texts = [
        "[номер недели=текущая]- присылает расписание на текущую неделю",
        "(день недели) [номер недели=текущая] - присылает расписание на день. Если указать номер недели, то на конкретную неделю",
    ]
