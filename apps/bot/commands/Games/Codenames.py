...
class Codenames(CommonCommand):
    name = 'коднеймс'
    names = ["кн"]
    help_text = "игра коднеймс"
    help_texts = [
        "- игра коднеймс",
        "правила - правила игры",
        "рег [роль=рандом] - регистрация в игре. Роли: капитан, игрок",
        "дерег - дерегистрация в игре",
        "старт - старт игры",
        "клава - текущая клавиатура игры",
        "инфо - команды, кол-во слов, чей ход, загаданное слово",
        "загадать (кол-во слов) (слово)",
        "слово (слово) - выбрать слово. Либо тык в клаву",
        "фиксклавы - рекомендации для фикса стилей клавиатуры",
        "удалить - удаляет сессию игры. Только для админа конфы"
    ]
