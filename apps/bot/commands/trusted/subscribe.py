...
class Subscribe(Command):
    ...
    help_texts = [
        "добавить (ссылка на канал/плейлист) - создаёт подписку на канал. Бот пришлёт тебе новое видео с канала",
    ...
    help_texts_extra = (
        "Проверка новых видео проходит каждые 10 минут\n"
        ...
        "Для ютуба поддерживаются плейлисты"
    )
