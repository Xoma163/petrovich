            ...
            fields=[
                ...
                ('board',
                 django.contrib.postgres.fields.jsonb.JSONField(default=apps.games.models.get_default_board, null=True,
                                                                verbose_name='Поле')),
                ('next_step', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                                related_name='next_tictactoesessions', to='bot.Users',
                                                verbose_name='Следующий шаг')),
                ('user1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                            related_name='user1_tictactoesessions', to='bot.Users',
                                            verbose_name='Пользователь *')),
                ('user2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                            related_name='user2_tictactoesessions', to='bot.Users',
